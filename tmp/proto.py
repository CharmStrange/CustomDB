...
class Struct(ct.Structure):
    ...
    def __str__(self):
        return f"Struct(Header={self.Header}, Data_int={self.Data_int}, Data_double={self.Data_double})"
...
class TitanVault:
    ...
    def new_struct(self, header, data_int, data_double):
        new_structure = Struct()
        new_structure.push(header, data_int, data_double)
